...
library(modeldata)
# Data exploration
bike_data_tbl <- readRDS("/Users/raza/Desktop/TUHH/New folder (2)/machine/bike_orderlines.rds")
...
model_sales_tbl %>%
  ...
  geom_violin() +
  geom_jitter(width = 0.1, alpha = 0.5, color = "#FF0000") +
  #coord_flip() +
...
bike_features_tbl <- readRDS("/Users/raza/Desktop/TUHH/New folder (2)/machine/bike_features_tbl.rds")
...
g2 <- g1 +
  geom_point(aes(y = .pred), color = "#808000", alpha = 0.5,
