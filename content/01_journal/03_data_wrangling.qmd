...
employee_attrition_tbl <- read_csv("/Users/raza/Desktop/TUHH/New folder (2)/machine/datasets-1067-1925-WA_Fn-UseC_-HR-Employee-Attrition.txt")
path_data_definitions <- "/Users/raza/Desktop/TUHH/New folder (2)/machine/data_definitions.xlsx"
...
dept_job_role_tbl %>%
  ...
  geom_segment(aes(xend = 0, yend = name),    color = "#FFFF00") +
  geom_point(  aes(size = cost_of_attrition), color = "#008080") +
  scale_x_continuous(labels = scales::dollar) +
  geom_label(aes(label = cost_text, size = cost_of_attrition),
             hjust = "inward", color = "#FF0000") +
...
product_data <- read_csv("/Users/raza/Desktop/TUHH/New folder (2)/machine/product_backorders.csv")
