...
```{r}
# STOCK PRICES
sp_500_prices_tbl <- read_rds("/Users/raza/Desktop/TUHH/New folder (2)/machine/sp_500_prices_tbl.rds")
sp_500_prices_tbl
```
...
```{r}
# SECTOR INFORMATION
sp_500_index_tbl <- read_rds("/Users/raza/Desktop/TUHH/New folder (2)/machine/sp_500_index_tbl.rds")
sp_500_index_tbl
```
...
```{r}
sp_500_daily_returns_tbl <- read_rds("/Users/raza/Desktop/TUHH/New folder (2)/machine/sp_500_daily_returns_tbl.rds")
sp_500_daily_returns_tbl
```
...
```{r}
stock_date_matrix_tbl <- read_rds("/Users/raza/Desktop/TUHH/New folder (2)/machine/stock_date_matrix_tbl.rds")
stock_date_matrix_tbl
```
...
k_means_mapped_tbl %>%
    ...
    geom_point(color = "#FF7F50", size = 4) +
    geom_line(color = "#DFFF00", size = 1) +
    # Add labels (which are repelled a little)
    ggrepel::geom_label_repel(aes(label = centers), color = "#CCCCFF") + 
...
```{r}
k_means_mapped_tbl <- read_rds("/Users/raza/Desktop/TUHH/New folder (2)/machine/k_means_mapped_tbl.rds")
k_means_mapped_tbl
```
...
```{r}
k_means_mapped_tbl <- read_rds("/Users/raza/Desktop/TUHH/New folder (2)/machine/k_means_mapped_tbl.rds")
umap_results_tbl   <- read_rds("/Users/raza/Desktop/TUHH/New folder (2)/machine/umap_results_tbl.rds")
umap_results_tbl 
k_means_mapped_tbl 
```
...
umap_kmeans_results_tbl %>%
    ...
    geom_point(alpha=0.5) +
    # Formatting
    scale_color_manual(values= c("#00FFFF", "#808000", "#FF0000")) +
